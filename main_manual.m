function main_manual
    ...
    sim.setStringSignal('controlMode', 'manual');
    ...
    % Manual control and data fetching loop
    userInput = 0;
    while sim.getSimulationState() ~= sim.simulation_stopped && userInput ~=27
        % Get laser data
        ...
        % Manual keyboard control input
        userInput = keyboardControl(sim, leftMotor, rightMotor, 1.0);
        disp(userInput);
    end
